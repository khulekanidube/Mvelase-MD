# Mvelase MD Termux-Hosting-Guide
...
##  Prerequisites
 ...
 ```SH
> git clone https://github.com/khulekanidube/Mvelase-MD
> cd Mvelase-MD
 ```
...
git clone https://github.com/<your-gitHub-Username>/Mvelase-MD
cd Mvelase-MD
npm install
npm start
```
...
```
 ...
 [Set it up on Heroku](https://github.com/khulekanidube/Mvelase-MD/blob/master/Heroku-Hosting-Guide.md)
