...
console.log("𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝗻𝗴 𝗠𝘃𝗲𝗹𝗮𝘀𝗲 𝗠𝗗...");
...
console.log('𝖯𝗅𝗎𝗀𝗂𝗇𝗌 𝖨𝗇𝗌𝗍𝖺𝗅𝗅𝖾𝖽 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 ✅')
console.log('𝖢𝗈𝗇𝗇𝖾𝖼𝗍𝗂𝗇𝗀 𝖬𝗏𝖾𝗅𝖺𝗌𝖾 𝖬𝖣 𝗍𝗈 𝗒𝗈𝗎𝗋 𝗐𝖺.𝖺𝖼𝖼𝗈𝗎𝗇𝗍 ✅')
...
app.get("/", (req, res) => {
res.send("𝗠𝘃𝗲𝗹𝗮𝘀𝗲 𝗠𝗗 𝗶𝘀 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱✅");
});
app.listen(port, () => console.log(`Mvelase Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);
