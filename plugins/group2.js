...
cmd({
    ...
    try {
        ...
        const channelLink = "https://whatsapp.com/channel/0029VajdbH511ulTyGysZq17";

        // Send the channel link to the user
        reply(`Here's 💁🏽 the link to our official WhatsApp Mvelase MD channel:\n\n${channelLink}\n\n> Join us to stay updated with the latest news and announcements🧞‍♂️.`);
    } catch (error) {
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://chat.whatsapp.com/D12hjas5ylQ7XWeWdVNwyO";
